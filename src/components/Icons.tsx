...
export const MoneyIcon = ({ w, h, fill }) => {
    return (
        <svg
            version="1.1"
            id="Capa_1"
            ...
            <g>
                <g>
                    <path
                        d="M28.905,21.905h-28c-0.399,0-0.716-0.239-0.842-0.578L0.006,21.91c-0.055,0.547,0.35,0.995,0.9,0.995h28
			c0.55,0,0.955-0.448,0.9-0.995l-0.059-0.583C29.621,21.666,29.305,21.905,28.905,21.905z"
                    />
                    <path
                        d="M28.905,19.905h-28c-0.399,0-0.716-0.239-0.842-0.578L0.006,19.91c-0.055,0.547,0.35,0.995,0.9,0.995h28
			c0.55,0,0.955-0.448,0.9-0.995l-0.059-0.583C29.621,19.666,29.305,19.905,28.905,19.905z"
                    />
                    <path
                        d="M28.905,17.905h-28c-0.399,0-0.716-0.239-0.842-0.578L0.006,17.91c-0.055,0.547,0.35,0.995,0.9,0.995h28
			c0.55,0,0.955-0.448,0.9-0.995l-0.059-0.583C29.621,17.666,29.305,17.905,28.905,17.905z"
                    />
                    <path
                        d="M0.906,16.905h28c0.55,0,0.955-0.448,0.9-0.995L29.005,7.9c-0.055-0.547-0.55-0.995-1.1-0.995h-26
			...
			c-0.075,0.082-0.184,0.128-0.307,0.128h-28c-0.123,0-0.231-0.045-0.306-0.128c-0.075-0.083-0.109-0.195-0.097-0.317L1.304,7.95z"
                    ...
                    <path
                        d="M28.01,8c-0.003-0.035-0.069-0.095-0.104-0.095h-26c-0.035,0-0.101,0.06-0.104,0.094l-0.791,7.906h27.827L28.01,8z
...
export const GlobeIcon = ({ w, h, fill }) => {
    return (
        <svg
            width={w ? w : '100px'}
            height={h ? h : '100px'}
